...
A collection of frontend projects built during **Scrimba** curriculum.
...
- [Basketball Scoreboard](./js/basketball-scoreboard/)
- [Passenger Counter App](./js/passenger-counter/)
